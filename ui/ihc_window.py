...
class IHCWindow(QWidget):
    ...
    def apply_style(self):
        self.setStyleSheet("""
            ...
            QComboBox::down-arrow {
                ...
                border-top: 5px solid #94a3b8; width: 0; height: 0;
            }
            QComboBox QAbstractItemView {
                background-color: #ffffff; color: #1e293b; border: 1px solid #e2e8f0;
                selection-background-color: #dbeafe; selection-color: #1e293b; outline: none;
            }
        """)
    ...
    def setup_ui(self):
        ...
        page_subtitle = QLabel("Tissue contour detection and DAB stain extraction")
        ...
        self.metric_cards = {}
        for k, v in {"DAB Coverage": "—", "Tissue Area": "—", "DAB Area": "—", "Mean Intensity": "—"}.items():
            card = MetricCard(k, v)
    ...
    def on_preview_complete(self, preview, tissue_info):
        ...
        self.status_badge.set_success(f"Tissue region detected\nArea: {int(area):,} px  |  {w}×{h}")
